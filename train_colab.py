...
def save2drive(saving_filename):
  file_metadata = {
...
def train_progressive_gan(
    ...
    resume_snapshot         = 2100,         # Snapshot index to resume training from, None = autodetect.
    ...
    save2drive(grid_reals)
    save2drive(grid_fakes)
    ...
    with open('network-final.pkl', mode='rb') as f:
      save2drive('network-final.pkl')
    summary_log.close()
