...
def generate_interpolation_video_choco(run_id, snapshot=None, grid_size=[1,1], image_shrink=1, image_zoom=1, duration_sec=60.0, smoothing_sec=1.0, mp4=None, mp4_fps=30, mp4_codec='libx265', mp4_bitrate='16M', random_seed=1000, minibatch_size=8):
    ...
    all_latents_10 = choco(all_latents, list(rnd.randint(0, 512, 10)))
    all_latents_40 = choco(all_latents, list(rnd.randint(0, 512, 40)))
    all_latents_80 = choco(all_latents, list(rnd.randint(0, 512, 80)))
    all_latents_120 = choco(all_latents, list(rnd.randint(0, 512, 120)))
