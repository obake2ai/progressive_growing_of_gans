...
desc += '-shunga_nuki_sym';          dataset = EasyDict(tfrecord_dir='shunga_nuki_sym')
#desc += '-maico2kiku';          dataset = EasyDict(tfrecord_dir='maico2kiku')
...
#desc += '-sneeuw';          dataset = EasyDict(tfrecord_dir='sneeuw')
...
#train = EasyDict(func='util_scripts.generate_fake_images', run_id=385, num_pngs=1000); num_gpus = 1; desc = 'sneeuw-' + str(train.run_id)
...
train = EasyDict(func='util_scripts.generate_interpolation_video_choco', run_id=280, snapshot=None, grid_size=[1,1], duration_sec=60.0, smoothing_sec=2.0, random_seed=2020); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
#train = EasyDict(func='util_scripts.generate_interpolation_video_choco', run_id=236, snapshot=None, chocos=512, num_chocos=20, grid_size=[1,1], duration_sec=12.0, smoothing_sec=1.0, random_seed=2013); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
...
#train = EasyDict(func='util_scripts.generate_interpolation_video_variation', run_id=393, snapshot=None ,grid_size=[1,1], duration_sec=12.0, smoothing_sec=1.0, random_seed=100, num_variation=100); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
