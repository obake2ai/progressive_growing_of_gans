...
#desc += '-shunga_mini';          dataset = EasyDict(tfrecord_dir='shunga_mini')
#desc += '-testdataset';          dataset = EasyDict(tfrecord_dir='testdataset')
...
desc += '-preset-v2-4gpus'; num_gpus = 4; sched.minibatch_base = 8; sched.minibatch_dict = {4: 256, 8: 256, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8}; sched.G_lrate_dict = {256: 0.0015, 512: 0.002, 1024: 0.003}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 12000
...
desc += '-fp32'; sched.max_minibatch_per_gpu = {256: 16, 512: 8, 1024: 2}
...
train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=250, grid_size=[1,1], duration_sec=16.0, smoothing_sec=1.0, random_seed=2000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=250, grid_size=[1,1], duration_sec=16.0, smoothing_sec=1.0, random_seed=1000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=250, grid_size=[1,1], duration_sec=16.0, smoothing_sec=1.0, random_seed=3000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=250, grid_size=[1,1], duration_sec=16.0, smoothing_sec=1.0, random_seed=4000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=250, grid_size=[1,1], duration_sec=16.0, smoothing_sec=1.0, random_seed=5000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)

train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=251, grid_size=[1,1], duration_sec=16.0, smoothing_sec=1.0, random_seed=2000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=251, grid_size=[1,1], duration_sec=16.0, smoothing_sec=1.0, random_seed=1000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=251, grid_size=[1,1], duration_sec=16.0, smoothing_sec=1.0, random_seed=3000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=251, grid_size=[1,1], duration_sec=16.0, smoothing_sec=1.0, random_seed=4000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=251, grid_size=[1,1], duration_sec=16.0, smoothing_sec=1.0, random_seed=5000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)

train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=252, grid_size=[1,1], duration_sec=16.0, smoothing_sec=1.0, random_seed=2000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=252, grid_size=[1,1], duration_sec=16.0, smoothing_sec=1.0, random_seed=1000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=252, grid_size=[1,1], duration_sec=16.0, smoothing_sec=1.0, random_seed=3000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=252, grid_size=[1,1], duration_sec=16.0, smoothing_sec=1.0, random_seed=4000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=252, grid_size=[1,1], duration_sec=16.0, smoothing_sec=1.0, random_seed=5000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)

train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=253, grid_size=[1,1], duration_sec=16.0, smoothing_sec=1.0, random_seed=2000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=253, grid_size=[1,1], duration_sec=16.0, smoothing_sec=1.0, random_seed=1000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=253, grid_size=[1,1], duration_sec=16.0, smoothing_sec=1.0, random_seed=3000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=253, grid_size=[1,1], duration_sec=16.0, smoothing_sec=1.0, random_seed=4000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=253, grid_size=[1,1], duration_sec=16.0, smoothing_sec=1.0, random_seed=5000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
# train = EasyDict(func='util_scripts.generate_interpolation_video_range', run_id=203, grid_size=[1,1], duration_sec=150.0, smoothing_sec=1.0, random_seed=2000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
