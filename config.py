...
train = EasyDict(func='util_scripts.generate_interpolation_video_variation', run_id=284, snapshot=None ,grid_size=[1,1], duration_sec=150.0, smoothing_sec=1.0, random_seed=3000, num_variation=10); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
