...
train = EasyDict(func='util_scripts.generate_interpolation', run_id=250, grid_size=[1,1], duration_sec=150.0, smoothing_sec=1.0, random_seed=2000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
train = EasyDict(func='util_scripts.generate_interpolation', run_id=251, grid_size=[1,1], duration_sec=150.0, smoothing_sec=1.0, random_seed=2000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
train = EasyDict(func='util_scripts.generate_interpolation', run_id=252, grid_size=[1,1], duration_sec=150.0, smoothing_sec=1.0, random_seed=2000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
train = EasyDict(func='util_scripts.generate_interpolation', run_id=253, grid_size=[1,1], duration_sec=150.0, smoothing_sec=1.0, random_seed=2000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
