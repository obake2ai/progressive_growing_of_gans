...
train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=111, grid_size=[1,1], duration_sec=300.0, smoothing_sec=1.0, random_seed=300); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
