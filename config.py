...
#train = EasyDict(func='util_scripts.generate_fake_images', run_id=218, num_pngs=300); num_gpus = 1; desc = 'fake-images-' + str(train.run_id)
...
train = EasyDict(func='util_scripts.generate_interpolation_video', run_id=216, grid_size=[1,1], duration_sec=300.0, smoothing_sec=1.0, random_seed=1000); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
