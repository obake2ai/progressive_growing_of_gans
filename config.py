...
train = EasyDict(func='util_scripts.generate_interpolation_video_choco', run_id=236, snapshot=None, chocos=10, num_chocos=20, grid_size=[1,1], duration_sec=12.0, smoothing_sec=1.0, random_seed=116); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
