...
#train = EasyDict(func='util_scripts.generate_fake_images', run_id=374, num_pngs=1000); num_gpus = 1; desc = 'sneeuw-' + str(train.run_id)
...
train = EasyDict(func='util_scripts.generate_interpolation_video_variation', run_id=376, snapshot=None ,grid_size=[1,1], duration_sec=10.0, smoothing_sec=1.0, random_seed=1000, num_variation=50); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
