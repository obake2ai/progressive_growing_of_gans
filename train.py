...
def train_progressive_gan(
    ...
    resume_snapshot         = 4382,         # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 4382,          # Assumed training progress at the beginning. Affects reporting and training schedule.
