...
def train_progressive_gan(
    ...
    resume_snapshot         = 4782,         # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 4782,          # Assumed training progress at the beginning. Affects reporting and training schedule.
