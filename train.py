...
def train_progressive_gan(
    ...
    resume_run_id           = 305,         # Run ID or network pkl to resume training from, None = start from scratch.
    resume_snapshot         = 7820,         # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 7820,          # Assumed training progress at the beginning. Affects reporting and training schedule.
