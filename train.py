...
def train_progressive_gan(
    ...
    resume_run_id           = 312,         # Run ID or network pkl to resume training from, None = start from scratch.
    resume_snapshot         = 9490,         # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 9490,          # Assumed training progress at the beginning. Affects reporting and training schedule.
