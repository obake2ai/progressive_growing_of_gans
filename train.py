...
def train_progressive_gan(
    ...
    resume_run_id           = 272,         # Run ID or network pkl to resume training from, None = start from scratch.
    resume_snapshot         = 11102,         # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 11102,          # Assumed training progress at the beginning. Affects reporting and training schedule.
