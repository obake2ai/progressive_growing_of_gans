...
def train_progressive_gan(
    ...
    resume_snapshot         = 5462,         # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 5462,          # Assumed training progress at the beginning. Affects reporting and training schedule.
