...
def train_progressive_gan(
    ...
    resume_snapshot         = 4142,         # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 4142.5,          # Assumed training progress at the beginning. Affects reporting and training schedule.
