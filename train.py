...
def train_progressive_gan(
    ...
    resume_snapshot         = 5102,         # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 5102,          # Assumed training progress at the beginning. Affects reporting and training schedule.
