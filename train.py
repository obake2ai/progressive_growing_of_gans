...
def train_progressive_gan(
    ...
    resume_run_id           = 203,         # Run ID or network pkl to resume training from, None = start from scratch.
    resume_snapshot         = 9000,         # Snapshot index to resume training from, None = autodetect.
