...
def train_progressive_gan(
    ...
    resume_snapshot         = 3541,         # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 3541.6,          # Assumed training progress at the beginning. Affects reporting and training schedule.
