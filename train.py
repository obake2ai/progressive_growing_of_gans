...
def train_progressive_gan(
    ...
    resume_snapshot         = 9600,         # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 9600,          # Assumed training progress at the beginning. Affects reporting and training schedule.
